package gg.steve.mc.skullwars.raids.framework.yml.utils;
...
public class YamlFileUtil extends PluginFile {
    ...
    public PluginFile load(String fileName, JavaPlugin instance) {
        ...
        try {
            ...
            LogUtil.warning("The supplied file " + fileName +
                    " was not found, please contact the nbdSteve#0583. Disabling the plugin.");
            instance.getServer().getPluginManager().disablePlugin(instance);
        } catch (IOException e) {
            LogUtil.warning("The supplied file " + fileName +
                    " could not be loaded, please contact the nbdSteve#0583. Disabling the plugin.");
            instance.getServer().getPluginManager().disablePlugin(instance);
        }
        return this;
    }
    ...
    public void reload() {
        try {
            ...
            LogUtil.warning("The supplied file " + fileName +
                    " could not be loaded, please contact nbdSteve#0583. Disabling the plugin.");
            instance.getServer().getPluginManager().disablePlugin(instance);
        }
    }
